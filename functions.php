...
function webflowstarter_scripts() {
	wp_enqueue_style( 'webflowstarter-style', get_stylesheet_uri() );

	wp_register_style('styleguide', get_template_directory_uri() . '/styleguide.css', array(), '1.6', 'all');
  wp_enqueue_style('styleguide'); // Enqueue it!

	wp_register_style('theme', get_template_directory_uri() . '/theme.css', array(), '1.6', 'all');
  wp_enqueue_style('theme'); // Enqueue it!

	wp_enqueue_script( 'webflowstarter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'webflowstarter-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
